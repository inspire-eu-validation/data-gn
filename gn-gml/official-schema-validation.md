...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/gn/4.0/GeographicalNames.xsd, using strict XML schema validation.
